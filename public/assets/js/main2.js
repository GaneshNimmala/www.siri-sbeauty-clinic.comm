!(function (e) {
      ...
      return this.each(function () {
        ...
        e(a).each(function () {
          e(this).on("click", function (t) {
            ...
            t.preventDefault(),
              (n = e(this).parent()),
              (a = n.children("ul")).length > 0 &&
                (n.toggleClass(s.subMenuParentToggle),
                a.slideToggle(s.toggleSpeed),
                a.toggleClass(s.subMenuToggleClass));
          });
        }),
  ...
  o.on("init reInit afterChange", function (e, t, s, n) {
    ...
    o.on("beforeChange", function (e, t, s, n) {
      ...
      r.css("background-size", a + "% 100%").attr("aria-valuenow", a),
        c.text(a + "% completed");
    });
  var u = e(".slick-3d-active");
  u
    .on("init", function (t, s, n) {
  ...
  o.on("init reInit afterChange", function (e, t, s, n) {
    ...
    e(".th-carousel").on("afterChange", function (t, s, n, a) {
      e(s.$slides).find("[data-ani]").removeClass("th-animated"),
        e(s.$slides[n]).find("[data-ani]").addClass("th-animated");
    });
  var p,
    h,
    f,
    ...
    (e.fn.sectionPosition = function (t, s) {
      e(this).each(function () {
        ...
        (n = Math.floor(l.height() / 2)),
          (a = l.attr(t)),
          (i = l.attr(s)),
          (o = y(e(i).css("padding-top"))),
          (r = y(e(i).css("padding-bottom"))),
          "top-half" === a
    ...
    (e.fn.asTab = function (t) {
      ...
      e(this).each(function () {
        ...
        if (
          (n.on("click", function (t) {
            ...
            n.addClass("active").siblings().removeClass("active"),
              s.sliderTab
                ? e(i).slick("slickGoTo", n.data("slide-go-to"))
                : r();
          }),
          s.sliderTab)
        ) {
          ...
          n.each(function () {
            var n = e(this);
            n.attr("data-slide-go-to", o),
              o++,
              n.hasClass("active") &&
                e(i).slick("slickGoTo", n.data("slide-go-to")),
              e(i).on("beforeChange", function (e, n, a, i) {
                t
        ...
        function r() {
          ...
          a.get(0).style.setProperty("--height-set", o),
            a.get(0).style.setProperty("--width-set", r),
            a.get(0).style.setProperty("--pos-y", l),
            a.get(0).style.setProperty("--pos-x", c),
            e(n).first().position().left == i.position().left
              ? a.addClass("start").removeClass("center").removeClass("end")
              : e(n).last().position().left == i.position().left
              ? a.addClass("end").removeClass("center").removeClass("start")
              : a.addClass("center").removeClass("start").removeClass("end");
        }
        r();
      });
    }),
      ...
      e(this).each(function () {
        ...
        if (
          (n.on("click", function (t) {
            ...
            var n = e(this);
            n.addClass("active").siblings().removeClass("active"),
              s.sliderTab && e(a).slick("slickGoTo", n.data("slide-go-to"));
          }),
          s.sliderTab)
        ) {
          ...
          n.each(function () {
            var n = e(this);
            n.attr("data-slide-go-to", i),
              i++,
              n.hasClass("active") &&
                e(a).slick("slickGoTo", n.data("slide-go-to")),
              e(a).on("beforeChange", function (e, n, a, i) {
                t.find(s.tabButton + '[data-slide-go-to="' + i + '"]')
                  .addClass("active")
                  .siblings()
                  .removeClass("active");
              });
    ...
    (e.fn.shapeMockup = function () {
      e(this).each(function () {
        var t = e(this),
          ...
          a = t.data("bottom"),
          i = t.data("left");
        t.css({ top: s, right: n, bottom: a, left: i })
          .removeAttr("data-top")
    ...
    (e.fn.indicator = function () {
      ...
      function o() {
        ...
        e(window).on("resize", function () {
          ...
          a.get(0).style.setProperty("--height-set", n),
          a.get(0).style.setProperty("--width-set", i),
          a.get(0).style.setProperty("--pos-y", o),
          a.get(0).style.setProperty("--pos-x", r);
      }
